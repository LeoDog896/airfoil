...
function getUnits(){
    ...
    var units = 1;
    if(unitsButton == "english â–¼"){
        units = 1;

    }
    else if (unitsButton == "metric â–¼"){
        units = 2;
    }
...
function flightButton(){
    ...
    if(getUnits() == 1){
        ...
        airLabel("airfoilLabel", "Flight Test", true);
        buttonText1("buttonText1", "Earth - Average Day â–¼");
        button1("button1", "Earth - Average Day", true)
        link1("link1",true, airfoilText,airfoilClicked,stallModelText,earthVal);
        link2("link2","Mars - Avg Day â–¼", true, ellipseText, ellipseClicked, idealFlowText, marsVal);
        link3("link3", "Water - Const Denst â–¼", true,plateText,plateClicked,waterDensityDisp);
        link4("link4","Venus-Surface â–¼", true, cylinderText, cylinderClicked, venusVal);
        link5("link5", "Specify Density" , false, ballText, ballClicked, specificDens);
        angleLabel("angleLabel", "Speed-km/h", true);
        angleBox("angleBox", true, String(velocity));
    ...
    if(environmentSelect == 1)
        document.getElementById("button1").innerHTML = "Earth - Average Day â–¼";
    else if(environmentSelect == 2)
        document.getElementById("button1").innerHTML = "Mars - Average Day â–¼";
    else if(environmentSelect == 3){
        document.getElementById("button1").innerHTML = "Water - Const Denst â–¼";
        camberLabel("camberLabel", "Depth-ft", true);
    }
...
function earthVal(){
    ...
    document.getElementById("button1").innerHTML = "Earth - Avg Day â–¼";
...
function marsVal(){
    ...
    document.getElementById("button1").innerHTML = "Mars - Avg Day â–¼";
...
function waterDensityDisp(){
    ...
    document.getElementById("button1").innerHTML = "Water-Const Density â–¼";
...
function venusVal(){
    ...
    document.getElementById("button1").innerHTML = "Venus-Surface â–¼";
...
function shapeButton(){
    ...
    if(shapeSelect == 1)
        document.getElementById("button1").innerHTML = "airfoil â–¼";
    else if(shapeSelect == 2)
        document.getElementById("button1").innerHTML = "ellipse â–¼";
    else if(shapeSelect == 3)
        document.getElementById("button1").innerHTML = "plate â–¼";
    else if(shapeSelect == 4)
        document.getElementById("button1").innerHTML = "cylinder â–¼";
    else if(shapeSelect == 5)
        document.getElementById("button1").innerHTML = "Ball â–¼";
